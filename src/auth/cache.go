...
func getUserKeyByToken(token AuthToken) ([]byte, error) {
...
func GetUserByToken(token AuthToken) (*models.User, error) {
...
func SetUserByToken(user *models.User, token AuthToken) error {
